    ...
    <h4 class="ym-fbox-heading"><?php echo __('Editar Pessoas Endereco'); ?></h4>
        ...
        'inputDefaults' => array(     
	        ...
	        <h5><?php echo $pessoa['Pessoa']['nome'] ?><h5>
		        <h6 class="ym-fbox-heading"><?php echo __('Dados Pessoas Endereco'); ?></h6>
        	<?php
    ...
    <div class="ym-col3" >
        ...
        <div class="actions ym-cbox">
	        <h4><?php echo __('Ações'); ?></h4>
        		        ...
        		        <?php echo $this->Form->postLink(__('Excluir'), array('action' => 'delete', $this->Form->value('PessoasEndereco.id')), array('class'=>'ym-button'), __('Você tem certeza que deseja excluir o # %s?', $this->Form->value('PessoasEndereco.id'))); ?>        		        <?php echo $this->Html->link(__('Listar Pessoas Enderecos'), array('action' => 'index'), array('class'=>'ym-button'));?>        <?php echo __('<h6>Pessoas</h6>'); ?>		<?php echo $this->Html->link(__('Listar Pessoas'), array('controller' => 'pessoas', 'action' => 'index'), array('class'=>'ym-button')); ?> 
