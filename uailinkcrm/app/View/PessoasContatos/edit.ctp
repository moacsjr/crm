        ...
        'inputDefaults' => array(     
            ...
            'error' => array(
              ...
              'class' => 'ym-error'
		        ...
		        <h6 class="ym-fbox-heading"><?php echo __('Dados Pessoas Contato'); ?></h6>
        	<?php
    ...
    <div class="ym-col3" >
        ...
        <div class="actions ym-cbox">
	        <h4><?php echo __('Ações'); ?></h4>
        		        ...
        		        <?php echo $this->Form->postLink(__('Excluir'), array('action' => 'delete', $this->Form->value('PessoasContato.id')), array('class'=>'ym-button'), __('Você tem certeza que deseja excluir o # %s?', $this->Form->value('PessoasContato.id'))); ?>        		        <?php echo $this->Html->link(__('Listar Pessoas Contatos'), array('action' => 'index'), array('class'=>'ym-button'));?>        <?php echo __('<h6>Pessoas</h6>'); ?>		<?php echo $this->Html->link(__('Listar Pessoas'), array('controller' => 'pessoas', 'action' => 'index'), array('class'=>'ym-button')); ?> 
